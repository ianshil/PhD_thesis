...
Lemma in_not_touched_remove : forall l1 (a0 a1 : MPropF V),
...
Lemma remove_not_in_anymore : forall l (A : MPropF V),
...
Lemma remove_preserv_NoDup : forall l (A : MPropF V), NoDup l -> NoDup (remove eq_dec_form A l).
Proof.
induction l.
...
Lemma NoDup_destr_split : forall l1 l2 (A : MPropF V), NoDup (l1 ++ A :: l2) -> NoDup (l1 ++ l2).
Proof.
induction l1.
...
Lemma remove_le_length : forall l (A : MPropF V), length (remove eq_dec_form A l) <= length l.
Proof.
induction l.
...
Lemma remove_In_smaller_length : forall l (A : MPropF V),
...
Lemma In_remove_diff : forall l (A B : MPropF V), In A (remove eq_dec_form B l) -> A <> B.
Proof.
induction l ; intros.
...
Fixpoint remove_list (l1 l2: list (MPropF V)) : list (MPropF V) :=
match l1 with
  | [] => l2
  | h1 :: t1 => remove eq_dec_form h1 (remove_list t1 l2)
end.

Lemma remove_list_of_nil : forall (l : list (MPropF V)), remove_list l nil = nil.
Proof.
induction l.
- simpl. reflexivity.
...
Lemma app_remove_list : forall (l1 l2 l3 : list (MPropF V)),
...
Lemma remove_list_dist_app : forall (l1 l2 l3 : list (MPropF V)),
...
Lemma permut_remove_remove_list : forall a (l1 l2 : list (MPropF V)),
...
Lemma swap_remove_list : forall (l1 l2 l3 : list (MPropF V)),
...
Lemma redund_remove_remove_list : forall a (l1 l2 : list (MPropF V)),
...
Lemma redund_remove : forall (l1 l2 l3 : list (MPropF V)) a,
...
Lemma redund_remove_list : forall (l1 l2 l3 : list (MPropF V)),
...
Lemma add_remove_list_preserve_NoDup : forall (l1 l2 : list (MPropF V)),
...
Lemma In_remove_same : forall l1 l2 (A : MPropF V), In A l1 ->
...
Lemma In_remove_length_same : forall l1 l2 (A : MPropF V), In A l1 ->
                length (remove_list l1 (A :: l2)) = length (remove_list l1 l2).
Proof.
intros. rewrite In_remove_same. reflexivity. assumption.
Qed.

Lemma length_le_remove_list : forall (l1 l2 : list (MPropF V)), length (remove_list l1 l2) <= length l2.
Proof.
induction l1.
- intros. auto.
...
Lemma remove_list_singl_id_or_nil : forall l (A : MPropF V), remove_list l [A] = nil \/ remove_list l [A] = [A].
Proof.
induction l.
- intros. right. auto.
...
Lemma remove_list_non_empty_inter_smaller_length : forall l2 l1 (A : MPropF V),
...
- induction l2.
  ...
  * split.
    ...
    + intros. simpl. rewrite permut_remove_remove_list. simpl. destruct (eq_dec_form a a0).
      ...
      { assert (H1: (forall A : MPropF V, In A l2 -> In A (a :: l1))). intros. apply H.
...
Lemma remove_delete_origin : forall l1 l2 (A B : MPropF V), (A <> B) ->
...
Lemma In_remove_In_list : forall (A B : MPropF V) l, In A (remove eq_dec_form B l) -> In A l.
Proof.
induction l ; intros.
...
Lemma In_remove_list_In_list : forall (A : MPropF V) l1 l2, In A (remove_list l1 l2) -> In A l2.
Proof.
...
Lemma In_remove_list_In_list_not_In_remove_list : forall (A : MPropF V) l1 l2,
...
Lemma remove_list_incr_decr3 : forall (l3 l2 l1 : list (MPropF V)),
              (incl l1 l2) ->
...
Lemma remove_list_incr_decr1 : forall (l3 l1 l2: list (MPropF V)),
...
- intros. destruct H. destruct H. destruct H1. destruct (eq_dec_form a x).
  ...
  * inversion H1. exfalso. apply n ; assumption.
    assert (H4: exists A : MPropF V, In A l2 /\ In A l3 /\ (In A l1 -> False)).
...
Lemma remove_list_incr_decr2 : forall (l4 l3 l1 : list (MPropF V)),
              (NoDup l4) ->
              (NoDup l3) ->
              (incl l4 l3) ->
...
Lemma remove_list_incr_decr4 : forall (l4 l3 l1: list (MPropF V)),
              (NoDup l4) ->
              (NoDup l3) ->
              (incl l4 l3) ->
              ((incl l3 l4) -> False) ->
...
Lemma remove_list_incr_decr : forall (l1 l2 l3 l4 : list (MPropF V)),
              (NoDup l4) ->
              (NoDup l3) ->
              (exists A, In A l2 /\ In A l3 /\ (In A l1 -> False)) ->
              (incl l1 l2) ->

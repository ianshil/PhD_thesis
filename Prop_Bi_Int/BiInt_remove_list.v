...
Lemma In_dec : forall l (a : BPropF V) , (In a l) + ((In a l) -> False).
Proof.
induction l.
...
Lemma in_not_touched_remove : forall l1 (a0 a1 : BPropF V),
...
Lemma remove_not_in_anymore : forall l (A : BPropF V),
...
Lemma remove_preserv_NoDup : forall l (A : BPropF V), NoDup l -> NoDup (remove eq_dec_form A l).
Proof.
induction l.
...
Lemma NoDup_destr_split : forall l1 l2 (A : BPropF V), NoDup (l1 ++ A :: l2) -> NoDup (l1 ++ l2).
Proof.
induction l1.
...
Lemma remove_le_length : forall l (A : BPropF V), length (remove eq_dec_form A l) <= length l.
Proof.
induction l.
...
Lemma remove_In_smaller_length : forall l (A : BPropF V),
...
- intros. simpl. destruct (eq_dec_form A a).
  ...
  * simpl. apply Lt.lt_n_S. apply IHl. inversion H. subst. exfalso. apply n. auto.
    assumption.
Qed.
...
Lemma In_remove_diff : forall l (A B : BPropF V), In A (remove eq_dec_form B l) -> A <> B.
Proof.
induction l ; intros.
...
Fixpoint remove_list (l1 l2: list (BPropF V)) : list (BPropF V) :=
match l1 with
  | [] => l2
  | h1 :: t1 => remove eq_dec_form h1 (remove_list t1 l2)
end.

Lemma remove_list_of_nil : forall (l : list (BPropF V)), remove_list l nil = nil.
Proof.
induction l.
- simpl. reflexivity.
...
Lemma app_remove_list : forall (l1 l2 l3 : list (BPropF V)),
...
Lemma remove_list_dist_app : forall (l1 l2 l3 : list (BPropF V)),
...
Lemma permut_remove_remove_list : forall a (l1 l2 : list (BPropF V)),
...
Lemma swap_remove_list : forall (l1 l2 l3 : list (BPropF V)),
...
Lemma redund_remove_remove_list : forall a (l1 l2 : list (BPropF V)),
...
Lemma redund_remove : forall (l1 l2 l3 : list (BPropF V)) a,
...
Lemma redund_remove_list : forall (l1 l2 l3 : list (BPropF V)),
...
Lemma add_remove_list_preserve_NoDup : forall (l1 l2 : list (BPropF V)),
...
Lemma In_remove_same : forall l1 l2 (A : BPropF V), In A l1 ->
...
Lemma In_remove_length_same : forall l1 l2 (A : BPropF V), In A l1 ->
                length (remove_list l1 (A :: l2)) = length (remove_list l1 l2).
Proof.
intros. rewrite In_remove_same. reflexivity. assumption.
Qed.

Lemma length_le_remove_list : forall (l1 l2 : list (BPropF V)), length (remove_list l1 l2) <= length l2.
Proof.
induction l1.
- intros. auto.
...
Lemma remove_list_singl_id_or_nil : forall l (A : BPropF V), remove_list l [A] = nil \/ remove_list l [A] = [A].
Proof.
induction l.
- intros. right. auto.
...
Lemma remove_list_non_empty_inter_smaller_length : forall l2 l1 (A : BPropF V),
...
- intros. simpl. destruct (eq_dec_form A a).
  ...
  * inversion H0.
    ...
    + assert (a :: l2 = [a] ++ l2). auto. rewrite H2. rewrite remove_list_dist_app.
      ...
      rewrite H3. simpl. apply Lt.lt_n_S. apply IHl2 with (A:=A) ; assumption.
Qed.
...
- intro l2. split.
  ...
  * intros. simpl. destruct l2.
    + reflexivity.
    + exfalso. pose (H b). assert (In b (b :: l2)). apply in_eq. apply i in H0. inversion H0.
- induction l2.
  * split.
    + intros. inversion H0.
  ...
  * split.
    ...
    + intros. simpl. rewrite permut_remove_remove_list. simpl. destruct (eq_dec_form a a0).
      ...
      { assert (H1: (forall A : BPropF V, In A l2 -> In A (a :: l1))). intros. apply H.
...
Lemma remove_delete_origin : forall l1 l2 (A B : BPropF V), (A <> B) ->
...
Lemma In_remove_In_list : forall (A B : BPropF V) l, In A (remove eq_dec_form B l) -> In A l.
Proof.
induction l ; intros.
...
Lemma In_remove_list_In_list : forall (A : BPropF V) l1 l2, In A (remove_list l1 l2) -> In A l2.
Proof.
...
Lemma In_remove_list_In_list_not_In_remove_list : forall (A : BPropF V) l1 l2,
...
Lemma remove_list_incr_decr3 : forall (l3 l2 l1 : list (BPropF V)),
              (incl l1 l2) ->
...
Lemma remove_list_incr_decr1 : forall (l3 l1 l2: list (BPropF V)),
...
- intros. destruct H. destruct H. destruct H1. destruct (eq_dec_form a x).
  ...
  * inversion H1. exfalso. apply n ; assumption.
    assert (H4: exists A : BPropF V, In A l2 /\ In A l3 /\ (In A l1 -> False)).
    ...
    + rewrite remove_list_delete_head_In. 2: assumption. destruct (In_dec l1 a).
      ...
      { rewrite keep_list_delete_head_not_In. 2: assumption. apply le_n_S.
        unfold lt in H4. apply Le.le_Sn_le. assumption. }
...
Lemma remove_list_incr_decr2 : forall (l4 l3 l1 : list (BPropF V)),
              (NoDup l4) ->
              (NoDup l3) ->
              (incl l4 l3) ->
...
Lemma remove_list_incr_decr4 : forall (l4 l3 l1: list (BPropF V)),
              (NoDup l4) ->
              (NoDup l3) ->
              (incl l4 l3) ->
              ((incl l3 l4) -> False) ->
...
- intros. destruct (In_dec l1 a).
  ...
  * rewrite keep_list_delete_head_not_In. 2: assumption. assert (In a l3). apply H1.
    ...
    rewrite keep_list_delete_head_not_origin. 2 : assumption. apply Lt.lt_n_S.
...
Lemma remove_list_incr_decr : forall (l1 l2 l3 l4 : list (BPropF V)),
              (NoDup l4) ->
              (NoDup l3) ->
              (exists A, In A l2 /\ In A l3 /\ (In A l1 -> False)) ->
              (incl l1 l2) ->
...
Proof.
induction l1.
- intros. destruct H. destruct l2. auto. unfold incl in H0. pose (H0 b). assert (In b (b :: l2)).
